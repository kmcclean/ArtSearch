...
from ArtSearchSite.ArtSearch.src.Art import Art
import operator
...
class Main:
    ...
    def start(self):
        ...
        #search_term = input("What would you like to find at museums? ")
        search_term = "Chuck Close"
    ...
    def create_amaa_object(self, seach_term):
        ...
        #This is the base search url for the website
        ...
        while True:
            ...
            # This is a check to see if the loop is finished. The website has certain markers that show up when it is finished
            # running through the returned responses. If this hits one of those, it breaks the loop.
    ...
    # this searches the Minneapolis Institute of Art, and creates an art objects for pieces that are returned as searches.
